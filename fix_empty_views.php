...
$pages = [
    ...
    'Jurusan' => [
        ...
        'title' => 'Jurusan',
        'columns' => [
            ['field' => 'name',         'label' => 'Nama Jurusan'],
            ['field' => 'kode_jurusan', 'label' => 'Kode Jurusan'],
        ],
    ],
    'JadwalAjar' => [
        'route' => 'jadwalajar',
        ...
        'columns' => [
            ...
            ['field' => 'jam_mulai',   'label' => 'Jam Mulai'],
            ['field' => 'jam_selesai', 'label' => 'Jam Selesai'],
        ],
    ],
    'AbsenMasuk' => [
        'route' => 'absenmasuk',
        ...
        'columns' => [
            ...
            ['field' => 'jam_masuk', 'label' => 'Jam Masuk'],
        ],
    ],
    'KetuaKelas' => [
        'route' => 'ketuakelas',
    ...
    'StatusKelas' => [
        ...
        'title' => 'Status Kelas',
        'columns' => [
            ['field' => 'mapel',    'label' => 'Mapel'],
            ['field' => 'pengajar', 'label' => 'Pengajar'],
            ['field' => 'is_active','label' => 'Aktif (1/0)'],
        ],
    ],
];
...
<div class=\"bg-white shadow-sm rounded-2xl overflow-hidden border border-slate-100\">
    <div class=\"p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3\">
        ...
        <a href=\"{{ route('{$route}.create') }}\" class=\"inline-flex items-center px-4 py-2 bg-brand-600 text-white rounded-xl text-sm font-medium hover:bg-brand-700 transition-colors shadow-sm\">
...
{$tds}                    <td class=\"px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3\">
                        <a href=\"{{ route('{$route}.edit', \$row->id) }}\" class=\"text-blue-600 hover:text-blue-800 font-semibold\">Edit</a>
                        <form method=\"POST\" action=\"{{ route('{$route}.destroy', \$row->id) }}\" class=\"inline\" onsubmit=\"return confirm('Hapus data ini?')\">
                            @csrf @method('DELETE')
...
echo "Index views regenerated successfully!";
