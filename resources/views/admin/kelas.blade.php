...
@section('title', 'Kelas - Monitoring Guru')
...
<div class="bg-white shadow-sm rounded-2xl overflow-hidden border border-slate-100">
    <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <a href="{{ route('kelas.create') }}" class="inline-flex items-center px-4 py-2 bg-brand-600 text-white rounded-xl text-sm font-medium hover:bg-brand-700 transition-colors shadow-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr>
                    <td colspan="100%" class="px-6 py-16 text-center text-slate-400">
                        ...
                        <p class="font-semibold text-slate-500">Belum ada data Kelas</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
