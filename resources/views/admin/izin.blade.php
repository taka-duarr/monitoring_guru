        ...
        <table class="w-full">
            <thead class="bg-slate-50 border-b border-slate-100">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Approval (1/0)</th>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700">{{ $row->approval }}</td>
