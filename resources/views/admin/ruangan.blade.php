...
@section('title', 'Manajemen Ruangan - SIMGURU')
...
<div x-data="{ 
    ...
    <div class="d-flex align-center justify-between mb-4">
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-primary-900">Data Ruangan</h2>
            <p class="text-sm text-neutral-500">Kelola daftar ruangan belajar, kelas, laboratorium, dan aula sekolah</p>
        </div>
        <div class="d-flex align-center gap-2">
            ...
            <div class="position-relative" @click.away="exportDropdownOpen = false">
                ...
                <div class="card shadow-md p-1" 
                    ...
                    <a href="{{ route('ruangan.export', array_merge(request()->query(), ['format' => 'pdf'])) }}" 
                    ...
                    <a href="{{ route('ruangan.export', array_merge(request()->query(), ['format' => 'excel'])) }}" 
                       class="d-flex align-center gap-2 px-2 py-2 text-sm text-neutral-700 hover-bg-neutral-50 rounded"
                       style="text-decoration: none;">
            ...
            <a href="{{ route('ruangan.create') }}" class="btn btn-primary d-flex align-center gap-2">
    ...
    <div class="table-wrapper card p-0 overflow-hidden" x-data="{ tableLoading: false }">
        ...
        @if($data->isEmpty())
            <div class="table-empty-state">
                ...
                <span class="table-empty-title">Tidak ada data ruangan</span>
                <span class="table-empty-sub">Belum ada ruangan yang terdaftar.</span>
                            ...
                            <td class="col-actions col-center">
                                <div class="action-buttons-group">
                                    ...
                                    <x-tooltip text="Edit Data">
                                        <a href="{{ route('ruangan.edit', $row->id) }}" class="btn btn-ghost action-edit">
                                    ...
                                    <x-tooltip text="Hapus Data">
                                        <button type="button" class="btn btn-ghost action-delete" 
                                                @click="$dispatch('confirm-delete', {
                                                    url: '{{ route('ruangan.destroy', $row->id) }}',
                                                    name: 'Ruangan {{ addslashes($row->name) }}'
                                                })">
    ...
    <div class="modal-backdrop" 
         ...
         style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(15, 23, 42, 0.6); backdrop-filter: blur(4px); z-index: 100; display: flex; align-items: center; justify-content: center; display: none;">
        ...
        <div class="card bg-white shadow-xl" 
            ...
            <div class="d-flex align-center justify-between pb-3 border-b border-neutral-100 mb-4">
                <h3 class="text-lg font-bold text-primary-900">Import Data Ruangan</h3>
            ...
            <!-- Form -->
            <form action="{{ route('ruangan.import') }}" method="POST" enctype="multipart/form-data" x-data="{ importing: false }" @submit="importing = true">
                @csrf
                
                <div class="d-flex flex-column gap-4">
                    <p class="text-sm text-neutral-600">
                        Unggah berkas data ruangan Anda dalam format <strong>Excel (.xlsx)</strong> atau <strong>CSV</strong>. Silakan unduh template di bawah untuk melihat kolom yang wajib diisi.
                    </p>

                    <!-- Template Link -->
                    <a href="{{ route('ruangan.import.template') }}" class="d-inline-flex align-center gap-2 text-sm text-primary font-semibold hover:underline" style="text-decoration: none;">
                    ...
                    <div class="mt-2 text-xs text-neutral-400">
                        * Catatan: Nama Ruangan harus unik dan tidak boleh sama dengan data yang sudah ada.
                    </div>
                </div>
