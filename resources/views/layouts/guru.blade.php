...
<body class="bg-slate-50 font-sans text-slate-800 antialiased h-screen flex flex-col pb-16">
    ...
    <nav class="fixed bottom-0 w-full bg-white border-t border-slate-200 flex justify-around items-center h-16 pb-safe z-50">
        ...
        <div class="relative w-full h-full flex justify-center">
            <a href="{{ route('guru.scan') }}" class="absolute -top-6 bg-brand-500 shadow-lg shadow-brand-500/40 text-white w-14 h-14 rounded-full flex items-center justify-center border-4 border-slate-50 transform transition active:scale-95">
